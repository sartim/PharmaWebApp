<!DOCTYPE HTML>
<head>
<title>PharmaGlobal | Register</title>
<meta charset="utf-8">
...
<!-- end header -->
<h1 class="logo">Register Account</h1>
<div id="container">
  <div class="content">
    ...
    <div id="fane1" class="tab_content">
      <h3>Fill in your details in all the fields below</h3>
  ...
  Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  Country:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  E-Mail:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  Company:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username"/><br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Register" name="submit" /><input type="reset" value="Cancel" name="Reset" />
